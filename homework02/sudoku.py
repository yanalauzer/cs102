...
def solve(grid: tp.List[tp.List[str]]) -> tp.Optional[tp.List[tp.List[str]]]:
    ...
    """Как решать Судоку? 1. Найти свободную позицию 
    2. Найти все возможные значения, которые могут находиться на 
    этой позиции 
    3.Для каждого возможного значения:
     3.1. Поместить это значение на эту позицию 
     3.2. Продолжить 
    решать оставшуюся часть пазла >>> grid = read_sudoku('puzzle1.txt') >>> solve(grid) 
    [['5', '3', '4', '6', '7', 
    '8', '9', '1', '2'], ['6', '7', '2', '1', '9', '5', '3', '4', '8'],
     ['1', '9', '8', '3', '4', '2', '5', '6', 
    '7'], ['8', '5', '9', '7', '6', '1', '4', '2', '3'], 
    ['4', '2', '6', '8', '5', '3', '7', '9', '1'], ['7', '1', 
    '3', '9', '2', '4', '8', '5', '6'], 
    ['9', '6', '1', '5', '3', '7', '2', '8', '4'], 
    ['2', '8', '7', '4', '1', '9', 
...
def check_solution(solution: tp.List[tp.List[str]]) -> bool:
    ...
    if solution is None or not isinstance(solution, list) or not all(isinstance(row, list) and all(isinstance(cell, str) for cell in row) for row in solution):
        return False
    for i in range(9):
        for j in range(9):
            if solution[i][j] == ".":
